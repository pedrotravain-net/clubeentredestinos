export default function Footer() {
  ...
  return (
    <footer className="bg-coffee text-cream/70 py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">

          {/* Logo e tagline */}
          <div className="text-center md:text-left">
            <p className="font-serif text-2xl text-cream mb-2">Entre Destinos</p>
            <p className="font-sans text-sm italic text-cream/50 font-light">
          ...
          <nav className="flex flex-wrap justify-center md:justify-end gap-x-8 gap-y-3">
            {[
              ...
              <a
                key={l.href}
                href={l.href}
                className="font-sans text-sm text-cream/60 hover:text-terracota transition-colors"
              >
                {l.label}
              </a>
            ))}
        ...
        <div className="mt-12 pt-8 border-t border-cream/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-sans text-xs text-cream/35 text-center md:text-left">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp do Entre Destinos"
              className="text-cream/40 hover:text-terracota transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
