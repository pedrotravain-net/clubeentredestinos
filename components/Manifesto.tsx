    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p>
            Mas a verdade é que essa sensação não precisa existir<br />
            só quando estamos longe de casa.
          </p>

          {/* "em uma taça de vinho," → quebra antes de "em uma página" e antes de "em uma nova amizade" */}
          <p>
            Ela pode aparecer em uma conversa, em um café, em um filme,<br />
            em uma trilha, em uma taça de vinho,<br />
            em uma página de diário ou<br />
            em uma nova amizade.
          </p>

          <div className="w-10 h-px bg-blush/30 mx-auto my-8" />

          {/* "amam a sensação" → quebra após "sensação" */}
          <p>
            Este clube nasceu para mulheres que amam viajar<br />
            — mas, acima de tudo, amam a sensação<br />
            de estar vivas.
          </p>
          <p className="text-cream/65">
            Mulheres que querem conhecer lugares, pessoas,<br />
            histórias e versões de si mesmas.
          </p>

          {/* "cada encontro é uma pequena" → quebra após "pequena" */}
          <p className="text-cream/65">
            Aqui, cada encontro é uma pequena<br />
            viagem simbólica.<br />
            Um convite para sair do automático, viver algo novo,<br />
            compartilhar histórias e lembrar que o mundo<br />
          ...
          {/* "porque viajar não é apenas deslocamento geográfico"
              → fonte maior para caber 3 linhas: "porque viajar" / "não é apenas" / "deslocamento geográfico" */}
          <p
            className="text-cream"
            style={{ fontSize: 'clamp(1.6rem, 4.5vw, 2.2rem)', lineHeight: '1.4' }}
          >
            Porque viajar<br />
            não é apenas<br />
